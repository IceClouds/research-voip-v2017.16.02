...
static const struct lwins_options lwins_opt[] =
{
    ...
    {"nbns-bind", LWINS_OPTION_LIST_IP},
    {"nbns-database-file", LWINS_OPTION_STRING},
    {"nbns-database-save-interval", LWINS_OPTION_INTEGER},
    {"replication-bind", LWINS_OPTION_LIST_IP},
    ...
    {"replication-pull-verify-max", LWINS_OPTION_INTEGER},
    {"replication-auto-discovery", LWINS_OPTION_ONOFF},
    {"replication-auto-discovery-interval", LWINS_OPTION_INTEGER},
    {"user", LWINS_OPTION_STRING},
    {"group", LWINS_OPTION_STRING},
    {"controlsocket", LWINS_OPTION_STRING},
};
...
int lwins_convert_to_integer (const char *param, unsigned int *ret)
{
    ...
    if (endptr == param || *endptr != '\0' || value == LONG_MIN || value == LONG_MAX || value < 0)
        return 0;
